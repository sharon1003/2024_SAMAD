...
class Predict(views.APIView):
    ...
    def file_elaboration(self, filepath):
        ...
        try:
            ...
            self.predictions.append(self.classtoemotion(1))
    ...
    def post(self, request):
        ...
        with self.graph.as_default():
            ...
            predictions = """Which tells the model to decode in English, under the task of speech recognition, and not to predict timestamps.
            ...
            score = "5"
            try:
                return Response({'predictions': predictions, 'score': score, 'show_prediction': show_prediction}, status=status.HTTP_200_OK)
            except ValueError as err:
                return Response(str(err), status=status.HTTP_400_BAD_REQUEST)
